...
#define FACTURATION_PROVIDED_MYSTRING_H

/**
 * @defgroup ProvidedString Provided functions
 * @ingroup String
 * @{
 */
 ...
 * than str2
 */
 int provided_icaseCompareString(const char * str1,
        const char * str2);
 ...
 */
 void provided_copyStringWithLength(char * dest, const char * src,
        size_t destSize);
 ...
 */
 char * provided_concatenateString(const char * str1,
        const char * str2);
 ...
 */
 ...
 void provided_dangerousStrCpy(char * dest, const char * src);
 void provided_dangerousStrNCpy(char * dest, const char * src,
        size_t destsize);
 char * provided_dangerousStrCat(const char * dest,
        const char * src);
 char * provided_dangerousStrNCat(const char * dest,
 ...
 */
 const char * provided_indexOfChar(const char *str, char c);
 ...
 */
 const char * provided_indexOfString(const char *meule_de_foin,
        const char *aiguille);
 ...
 * @return the new string
 */
 char * provided_insertString(const char * src, int insertPosition,
