...
#ifndef FACTURATION_USER_CUSTOMERDB_H
#define FACTURATION_USER_CUSTOMERDB_H

/** @defgroup UserCustomerDB User functions
 * @ingroup CustomerDB
 * @{
 */
 ...
 * @relates CustomerDB
 */
CustomerDB * user_CustomerDB_create(const char * filename);
 ...
 * @relates CustomerDB
 */
CustomerDB * user_CustomerDB_open(const char * filename);
 ...
 * @relates CustomerDB
 */
CustomerDB * user_CustomerDB_openOrCreate(const char * filename);
 ...
 * @relates CustomerDB
 */
void user_CustomerDB_close(CustomerDB * customerDB);
 ...
 * @relates CustomerDB
 */
int user_CustomerDB_getRecordCount(CustomerDB * customerDB);
 ...
 * @relates CustomerDB
 */
void user_CustomerDB_appendRecord(CustomerDB * customerDB, CustomerRecord *record);
 ...
 * @relates CustomerDB
 */
void user_CustomerDB_insertRecord(CustomerDB * customerDB, int recordIndex, CustomerRecord * record);
 ...
 * @relates CustomerDB
 */
void user_CustomerDB_removeRecord(CustomerDB * customerDB, int recordIndex);
 ...
 * @relates CustomerDB
 */
void user_CustomerDB_readRecord(CustomerDB * customerDB, int recordIndex, CustomerRecord * record);
 ...
 * @relates CustomerDB
 */
void user_CustomerDB_writeRecord(CustomerDB * customerDB, int recordIndex, CustomerRecord * record);
